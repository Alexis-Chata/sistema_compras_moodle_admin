<header class="navbar-light navbar-sticky header-static">
    ...
    <nav class="navbar navbar-expand-xl">
        <div class="container-fluid px-3 px-xl-5">
            ...
            <button class="navbar-toggler ms-auto" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse" aria-controls="navbarCollapse" aria-expanded="false"
            ...
            <div class="navbar-collapse w-100 collapse" id="navbarCollapse">
                ...
                <ul class="navbar-nav navbar-nav-scroll me-auto">
                    ...
                    <!-- Nav item 2 Menu -->
                    <li class="nav-item dropdown">
                        <a class="nav-link {{ Route::currentRouteName() == 'cursos' ? 'active' : '' }}" href="{{ route('cursos') }}">Cursos</a>
                    </li>
                    @auth
                        <!-- Nav item 3 Menu -->
                        <li class="nav-item dropdown">
                            <a class="nav-link {{ Route::currentRouteName() == 'mycursos' ? 'active' : '' }}" href="{{ route('mycursos') }}">Mis Cursos</a>
                        </li>
                    @endauth
                    <!-- Nav item 1 Demos -->
            ...
            @auth
                ...
                <div class="dropdown ms-1 ms-lg-0">
                    <a class="avatar avatar-sm p-0" href="#" id="profileDropdown" role="button" data-bs-auto-close="outside" data-bs-display="static" data-bs-toggle="dropdown"
                        aria-expanded="false">
                        <img class="avatar-img rounded-circle"
                    ...
                    <ul class="dropdown-menu dropdown-animation dropdown-menu-end shadow pt-3" aria-labelledby="profileDropdown">
                        ...
                        <!-- Links -->
                        <li><a class="dropdown-item" href="{{ route('profile.show') }}"><i class="bi bi-person fa-fw me-2"></i>Editar Perfil</a></li>
                        ...
                        <li>
                            <form method="POST" action="http://sistema_compras_moodle.test/logout" x-data="">
                                @csrf
                                <button class="dropdown-item bg-danger-soft-hover" href="#"><i class="bi bi-power fa-fw me-2"></i>Cerrar Sesion</button>
                            </form>
                        </li>
                        <li>
                            <hr class="dropdown-divider">
            ...
            @guest
                <div class="navbar-nav">
                    <a href="{{ route('login') }}" class="btn btn-sm btn-dark mb-0"><i class="bi bi-power me-2"></i>Iniciar Sesion</a>
                </div>
            @endguest
        </div>
    </nav>
