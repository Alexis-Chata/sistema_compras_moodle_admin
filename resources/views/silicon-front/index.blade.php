            ...
            <div class="container">
                ...
                <ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab"
                    ...
                    @foreach ($cursos as $key=>$curso)
                        ...
                        <li class="nav-item me-2 me-sm-5">
                            <button class="nav-link mb-2 mb-md-0 {{ $key == array_key_first($cursos->toArray()) ? 'active' : '' }}" id="course-pills-tab-{{ $curso->id }}"
                                data-bs-toggle="pill" data-bs-target="#course-pills-tabs-{{ $curso->id }}"
                                type="button" role="tab" aria-controls="course-pills-tabs-{{ $curso->id }}"
                ...
                <div class="tab-content" id="course-pills-tabContent">
                    ...
                    @foreach ($cursos as $key => $curso)
                        ...
                        <!-- Content START -->
                        <div class="tab-pane fade {{ $key == array_key_first($cursos->toArray()) ? 'show active' : '' }}" id="course-pills-tabs-{{ $curso->id }}" role="tabpanel"
                                        ...
                                        <div class="card shadow h-100">
                                            ...
                                            <div class="card-body pb-0">
                                                ...
                                                <p class="mb-2 text-truncate-2">
                                                    {{ $grupo->descripcion ??
                                                        "Proposal indulged no do sociable he throwing
                                                                                            settling." }}
                                                </p>
                                                <!-- Rating star -->
