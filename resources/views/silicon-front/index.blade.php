                        ...
                        <div class="ms-4 h6 fw-normal mb-0">
                            <div class="d-flex">
                                <h5 class="purecounter mb-0 fw-bold" data-purecounter-start="0" data-purecounter-end="6"
                                    data-purecounter-delay="300" data-purecounter-duration="0">6</h5>
                                <span class="mb-0 h5">K+</span>
                            </div>
            ...
            <ul class="nav nav-pills nav-pills-bg-soft justify-content-sm-center mb-4 px-3" id="course-pills-tab"
                ...
                <li class="nav-item me-2 me-sm-5" role="presentation">
                    <button
                        ...
                        aria-controls="course-pills-tabs-{{ $categoria->id }}" aria-selected="true">{{ $categoria->name
                        }}
                    </button>
                </li>
                @endforeach
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-sm">
                                                            <img class="avatar-img rounded-1"
                                                                src="{{ asset('silicon-front/silicon/04.jpg') }}"
                                                                alt="avatar">
                                                        </div>
                                            ...
                                            <div class="card-footer pt-0 bg-transparent">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-sm">
                                                            <img class="avatar-img rounded-1"
                                                                src="{{ asset('silicon-front/silicon/09.jpg') }}"
                                                                alt="avatar">
                                                        </div>
                                            ...
                                            <div class="card-footer pt-0 bg-transparent">
                                                ...
                                                <div class="d-flex justify-content-between align-items-center">
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        <div class="avatar avatar-sm">
                                                            <img class="avatar-img rounded-1"
                                                                src="{{ asset('silicon-front/silicon/01.jpg') }}"
                                                                alt="avatar">
                                                        </div>
