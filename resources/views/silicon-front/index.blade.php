                            ...
                            <div class="d-flex align-items-center justify-content-center py-2 ms-0 ms-sm-4">
                                <a data-glightbox="" data-gallery="office-tour" href="https://www.youtube.com/embed/tXHviS-4ygo" class="btn btn-round btn-primary-shadow mb-0 overflow-visible me-7"
                                    ...
                                    <h6 class="mb-0 ms-3 fw-normal position-absolute start-100 top-50 translate-middle-y">
                                        ...
                                        target="_blank" title="Obtener un enlace directo" savefrom_lm="1" savefrom_lm_is_link="1"
                        ...
                        <div class="p-3 bg-success d-inline-block rounded-4 shadow-lg position-absolute top-50 end-0 translate-middle-y mt-n7 z-index-1 d-none d-md-block"
                            ...
                            <ul class="avatar-group mb-0">
                                <li class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle border-white" src="{{ asset('silicon-front/silicon/01.jpg') }}" alt="avatar">
                                </li>
                                <li class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle border-white" src="{{ asset('silicon-front/silicon/02.jpg') }}" alt="avatar">
                                </li>
                                <li class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle border-white" src="{{ asset('silicon-front/silicon/03.jpg') }}" alt="avatar">
                                </li>
                                <li class="avatar avatar-sm">
                                    <img class="avatar-img rounded-circle border-white" src="{{ asset('silicon-front/silicon/04.jpg') }}" alt="avatar">
                                </li>
                                <li class="avatar avatar-sm">
        ...
        <section>
            <div class="container">
                ...
                <div class="tab-content" id="course-pills-tabContent">
                    ...
                    @foreach ($categorias as $key => $categoria)
                        <!-- Content START -->
                        <div class="tab-pane fade {{ $key == array_key_first($categorias->toArray()) ? 'show active' : '' }}" id="course-pills-tabs-{{ $categoria->id }}" role="tabpanel"
                        ...
                        <div class="tiny-slider-inner pb-1" data-autoplay="true" data-arrow="true" data-edge="2" data-dots="false" data-items="3" data-items-lg="2" data-items-sm="1">
                            ...
                            <div>
                                <div class="card action-trigger-hover border bg-transparent">
                                    <!-- Image -->
                                    <img src="{{ asset('silicon-front/silicon/15.jpg') }}assets/images/courses/4by3/14.jpg" class="card-img-top" alt="course image">
                                    <!-- Ribbon -->
                        ...
                        <div class="col-md-7 position-relative mb-0 mt-0 mt-md-5">
                            ...
                            <div class="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                                ...
                                <div class="avatar avatar-xl mb-3">
                                    <img class="avatar-img rounded-circle" src="./silicon-front/silicon/01.jpg"
                                        alt="avatar">
                                </div>
                                <!-- Content -->
                                <blockquote>
                        ...
                        <div class="col-md-5 mt-5 mt-md-0 d-none d-md-block">
                            <div class="bg-body shadow p-4 rounded-3 d-inline-block position-relative">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="./silicon-front/silicon/09.jpg"
                                            alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                                ...
                                <div class="d-flex align-items-center mb-3">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="./silicon-front/silicon/04.jpg"
                                            alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                                ...
                                <div class="d-flex align-items-center">
                                    <!-- Avatar -->
                                    <div class="avatar avatar-sm">
                                        <img class="avatar-img rounded-1" src="./silicon-front/silicon/02.jpg"
                                            alt="avatar">
                                    </div>
                                    <!-- Info -->
                                    <div class="ms-2">
                    ...
                    <div class="row mt-5 mt-xl-0">
                        ...
                        <div class="col-7 mt-0 mt-xl-5 text-end position-relative z-index-1 d-none d-md-block">
                            ...
                            <div class="p-3 bg-primary d-inline-block rounded-4 shadow-lg text-center"
                                style="background:url(silicon-front/assets/images/pattern/02.png) no-repeat center center; background-size:cover;">
                                <!-- Info -->
                        ...
                        <div class="col-md-5 mt-n6 mb-0 mb-md-5">
                            <div class="bg-body shadow text-center p-4 rounded-3">
                                <!-- Avatar -->
                                <div class="avatar avatar-xl mb-3">
                                    <img class="avatar-img rounded-circle" src="./silicon-front/silicon/03.jpg"
                                        alt="avatar">
                                </div>
                                <!-- Content -->
                                <blockquote>
