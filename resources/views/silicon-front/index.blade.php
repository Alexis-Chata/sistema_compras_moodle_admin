                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="{{ isset($curso->imagen) && $curso->imagen != '' ? './silicon-front/silicon/'.$curso->imagen : './silicon-front/silicon/08.jpg' }}"
                    ...
                    <div class="tab-pane fade" id="course-pills-tabs-5" role="tabpanel"
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="./silicon-front/silicon/04(1).jpg" class="card-img-top"
                                        alt="course image">
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <div class="col-sm-6 col-lg-4 col-xl-3">
                                <div class="card shadow h-100">
                                    <!-- Image -->
                                    <img src="./silicon-front/silicon/09(1).jpg" class="card-img-top"
                                        alt="course image">
                                    <div class="card-body pb-0">
                                        <!-- Badge and favorite -->
                                        <div class="d-flex justify-content-between mb-2">
