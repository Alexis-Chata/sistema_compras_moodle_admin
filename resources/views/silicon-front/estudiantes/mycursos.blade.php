                            ...
                            <div class="choices" data-type="select-one" tabindex="0" role="combobox"
                                ...
                                <div class="choices__list choices__list--dropdown" aria-expanded="false"><input
                                    ...
                                    <div class="choices__list" role="listbox">
                                        <div id="choices--7voe-item-choice-5"
                                        ...
                                        <div id="choices--7voe-item-choice-1"
                                        ...
                                        <div id="choices--7voe-item-choice-2"
                                            class="choices__item choices__item--choice choices__item--selectable"
                                        ...
                                        <div id="choices--7voe-item-choice-3"
                                            class="choices__item choices__item--choice choices__item--selectable"
                                        ...
                                        <div id="choices--7voe-item-choice-4"
                                            class="choices__item choices__item--choice choices__item--selectable"
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="d-flex align-items-center">
                                        <!-- Image -->
                                        <div class="w-100px">
                                            <img src="silicon-front/assets/images/courses/4by3/03.jpg" class="rounded"
                                                alt="">
                                        </div>
                                        <div class="mb-0 ms-2">
                                            <!-- Title -->
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="mb-0 ms-2">
                                                ...
                                                <div class="overflow-hidden">
                                                    ...
                                                    <div class="progress progress-sm bg-primary bg-opacity-10">
                                                        <div class="progress-bar bg-primary aos aos-init"
