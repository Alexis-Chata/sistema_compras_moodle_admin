                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-header border-bottom p-0 pb-3">
                                            ...
                                            <div class="d-sm-flex justify-content-between align-items-center">
                                                ...
                                                <!-- Buttons -->
                                                @if(!$inscrito)
                                                @livewire('additem', ['curso' => $modalidad->curso, 'modalidad' =>
                                                $modalidad])
                                                @endif
                                                    ...
                                                    <span class="h6 fw-light mb-0">
                                                        <button type="button"
                                                            ...
                                                            <svg xmlns="http://www.w3.org/2000/svg" width="1.25em"
                                                                ...
                                                                class="svg-icon normal s-mr-05 fill blue-500 undefined"
                                                                fill="currentColor">
                                                            ...
                                                            <span
                                                                class="color s-font-semibold blue-500 s-whitespace-nowrap undefined">Inscrito</span>
                                                        </button>
                                                    </span>
                                                </div>
                                                @endif
                                        ...
                                        <div class="card-body p-0 pt-3">
                                            ...
                                            <div class="row g-4">
                                                ...
                                                <div class="col-sm-10 col-xl-11">
                                                    <h5>{{ $gcuota->grupo->name }} - {{ $cuota->name }} <span>( $ {{
                                                            number_format($cuota->monto, 2) }} )</span></h5>
                                                    <p>
                                                    ...
                                                    <div class="hstack gap-3 flex-wrap">
                                                        ...
                                                        <a href="#" class="text-success mb-0"><i
                                                                class="bi bi-pencil-square me-2"></i>Pagado</a>
                                                        <a href="#" class="text-danger mb-0"><i
                                                                class="bi bi-trash me-2"></i>Pendiente</a>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="tab-pane fade" id="course-pills-3" role="tabpanel"
                                    ...
                                    <div class="card mb-0 mb-md-4">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-md-5">
                                                <!-- Image -->
                                                <img src="{{ asset('silicon-front/assets/images/instructor/01.jpg') }}"
                                ...
                                <div class="tab-pane fade" id="course-pills-4" role="tabpanel"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="d-md-flex my-4">
                                            ...
                                            <div class="avatar avatar-xl me-4 flex-shrink-0">
                                                <img class="avatar-img rounded-circle"
                                                    src="{{ asset('silicon-front/assets/images/avatar/09.jpg') }}"
                                                    alt="avatar">
                                            </div>
                                            <!-- Text -->
                                            <div>
                                        ...
                                        <div class="d-md-flex my-4">
                                            ...
                                            <div class="avatar avatar-xl me-4 flex-shrink-0">
                                                <img class="avatar-img rounded-circle"
                                                    src="{{ asset('silicon-front/assets/images/avatar/07.jpg') }}"
                                                    alt="avatar">
                                            </div>
                                            <!-- Text -->
                                            <div>
                        ...
                        <div class="col-md-6 col-lg-12">
                            ...
                            <div class="card shadow p-2 mb-4 z-index-9">
                                <div class="overflow-hidden rounded-3">
                                    ...
                                    <img src="{{ asset($modalidads->first()->curso->imagen) }}" class="card-img"
                                        alt="course image" id="imagen_video">
                                    @else
                                    <img src="{{ asset('silicon-front/assets/images/courses/4by3/01.jpg') }}"
                        ...
                        <div class="col-md-6 col-lg-12">
                            ...
                            <div class="card card-body shadow p-4 mb-4">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-4">
                                        <img class="rounded"
                                            src="{{ asset('silicon-front/assets/images/courses/4by3/21.jpg') }}" alt="">
                                    </div>
                                    <!-- Info -->
                                    <div class="col-8">
                                ...
                                <div class="row gx-3">
                                    ...
                                    <div class="col-4">
                                        <img class="rounded"
                                            src="{{ asset('silicon-front/assets/images/courses/4by3/18.jpg') }}" alt="">
                                    </div>
                                    <!-- Info -->
                                    <div class="col-8">
                    ...
                    <div class="tiny-slider-inner" data-autoplay="false" data-arrow="true" data-edge="2"
                            ...
                            <div class="card p-2 border">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <img src="{{ asset('silicon-front/assets/images/courses/4by3/17.jpg') }}"
                        ...
                        <div class="pb-4">
                            <div class="card p-2 border">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <img src="{{ asset('silicon-front/assets/images/courses/4by3/18.jpg') }}"
                                            class="card-img-top" alt="course image">
                                    </div>
                                    <!-- Hover element -->
                                    <div class="card-img-overlay">
                        ...
                        <div class="pb-4">
                            <div class="card p-2 border">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <img src="{{ asset('silicon-front/assets/images/courses/4by3/21.jpg') }}"
                                            class="card-img-top" alt="course image">
                                    </div>
                                    <!-- Hover element -->
                                    <div class="card-img-overlay">
                        ...
                        <div class="pb-4">
                            <div class="card p-2 border">
                                <div class="rounded-top overflow-hidden">
                                    <div class="card-overlay-hover">
                                        <img src="{{ asset('silicon-front/assets/images/courses/4by3/20.jpg') }}"
                                            class="card-img-top" alt="course image">
                                    </div>
                                    <!-- Hover element -->
                                    <div class="card-img-overlay">
