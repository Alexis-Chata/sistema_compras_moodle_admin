        ...
        <section class="bg-light py-0 py-sm-5">
            <div class="container">
                <div class="row py-5">
                    <div class="col-lg-8">
                        <!-- Badge -->
                        <h6 class="mb-3 font-base bg-primary text-white py-2 px-4 rounded-2 d-inline-block">{{ $curso->categoria->name }}</h6>
                        <!-- Title -->
                        <h1>{{ $curso->name }}</h1>
                                    ...
                                    <div class="tab-pane fade" id="course-pills-3" role="tabpanel"
                                        ...
                                        <div class="card mb-0 mb-md-4">
                                            <div class="row g-0 align-items-center">
                                                <div class="col-md-5">
                                                    <!-- Image -->
                                                    <img src="{{ asset('silicon-front/assets/images/instructor/01.jpg') }}" class="img-fluid rounded-3"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="d-md-flex my-4">
                                                ...
                                                <div class="avatar avatar-xl me-4 flex-shrink-0">
                                                    <img class="avatar-img rounded-circle"
                                                        src="{{ asset('silicon-front/assets/images/avatar/09.jpg') }}" alt="avatar">
                                                </div>
                                                <!-- Text -->
                                                <div>
                                            ...
                                            <div class="d-md-flex mb-4 ps-4 ps-md-5">
                                                ...
                                                <div class="avatar avatar-lg me-4 flex-shrink-0">
                                                    <img class="avatar-img rounded-circle"
                                                        src="{{ asset('silicon-front/assets/images/avatar/02.jpg') }}" alt="avatar">
                                                </div>
                                                <!-- Text -->
                                                <div>
                                                    <div class="d-sm-flex mt-1 mt-md-0 align-items-center">
                                            ...
                                            <div class="d-md-flex my-4">
                                                ...
                                                <div class="avatar avatar-xl me-4 flex-shrink-0">
                                                    <img class="avatar-img rounded-circle"
                                                        src="{{ asset('silicon-front/assets/images/avatar/07.jpg') }}" alt="avatar">
                                                </div>
                                                <!-- Text -->
                                                <div>
                                                    <div class="d-sm-flex mt-1 mt-md-0 align-items-center">
                                                ...
                                                <div class="d-flex mb-4">
                                                    ...
                                                    <div class="avatar avatar-sm flex-shrink-0 me-2">
                                                        <a href="#"> <img class="avatar-img rounded-circle"
                                                                src="{{ asset('silicon-front/assets/images/avatar/09.jpg') }}" alt=""> </a>
                                                    </div>
                                                            ...
                                                            <div class="d-flex mb-3">
                                                                ...
                                                                <div class="avatar avatar-sm flex-shrink-0">
                                                                    <a href="#"><img
                                                                            ...
                                                                            src="{{ asset('silicon-front/assets/images/avatar/05.jpg') }}"
                                                                            alt=""></a>
                                                                </div>
                                                                <div class="ms-2">
                                                                    <!-- Comment by -->
                                                                ...
                                                                <li class="comment-item">
                                                                    <div class="d-flex">
                                                                        ...
                                                                        <div class="avatar avatar-xs flex-shrink-0">
                                                                            <a href="#"><img
                                                                                    class="avatar-img rounded-circle"
                                                                                    src="{{ asset('silicon-front/assets/images/avatar/06.jpg') }}"
                                                                                    alt=""></a>
                                                                        </div>
                                                                        <!-- Comment by -->
                                                                        <div class="ms-2">
                            ...
                            <div class="col-md-6 col-lg-12">
                                ...
                                <div class="card shadow p-2 mb-4 z-index-9">
                                    <div class="overflow-hidden rounded-3">
                                        <img src="{{ asset('silicon-front/assets/images/courses/4by3/01.jpg') }}" class="card-img"
                                            alt="course image">
                                        <!-- Overlay -->
                            ...
                            <div class="col-md-6 col-lg-12">
                                ...
                                <div class="card card-body shadow p-4 mb-4">
                                    ...
                                    <div class="row gx-3 mb-3">
                                        <!-- Image -->
                                        <div class="col-4">
                                            <img class="rounded" src="{{ asset('silicon-front/assets/images/courses/4by3/21.jpg') }}"
                                                alt="">
                                        </div>
                                        <!-- Info -->
                                        <div class="col-8">
                                    ...
                                    <div class="row gx-3">
                                        <!-- Image -->
                                        <div class="col-4">
                                            <img class="rounded" src="{{ asset('silicon-front/assets/images/courses/4by3/18.jpg') }}"
                                                alt="">
                                        </div>
                                        <!-- Info -->
                                        <div class="col-8">
                        ...
                        <div class="tiny-slider-inner" data-autoplay="false" data-arrow="true" data-edge="2"
                                ...
                                <div class="card p-2 border">
                                    <div class="rounded-top overflow-hidden">
                                        <div class="card-overlay-hover">
                                            <img src="{{ asset('silicon-front/assets/images/courses/4by3/17.jpg') }}" class="card-img-top"
                                                alt="course image">
                                        </div>
                                        <!-- Hover element -->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-circle" src="{{ asset('silicon-front/assets/images/avatar/09.jpg') }}"
                                                    alt="avatar">
                                            </div>
                                        </div>
                                        <!-- Divider -->
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a href="#" class="badge bg-info bg-opacity-10 text-info"><i
                                                    class="fas fa-circle small fw-bold me-2"></i>Personal Development</a>
                                            <!-- Price -->
                            ...
                            <div class="pb-4">
                                <div class="card p-2 border">
                                    <div class="rounded-top overflow-hidden">
                                        <div class="card-overlay-hover">
                                            <img src="{{ asset('silicon-front/assets/images/courses/4by3/18.jpg') }}" class="card-img-top"
                                                alt="course image">
                                        </div>
                                        <!-- Hover element -->
                                        <div class="card-img-overlay">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <!-- Avatar -->
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-circle" src="{{ asset('silicon-front/assets/images/avatar/07.jpg') }}"
                                                    alt="avatar">
                                            </div>
                                        </div>
                                        <!-- Divider -->
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <a href="#" class="badge bg-info bg-opacity-10 text-info"><i
                                                    class="fas fa-circle small fw-bold me-2"></i>Business Development</a>
                                            <!-- Price -->
                            ...
                            <div class="pb-4">
                                <div class="card p-2 border">
                                    <div class="rounded-top overflow-hidden">
                                        <div class="card-overlay-hover">
                                            <img src="{{ asset('silicon-front/assets/images/courses/4by3/21.jpg') }}" class="card-img-top"
                                                alt="course image">
                                        </div>
                                        <!-- Hover element -->
                                        <div class="card-img-overlay">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <!-- Avatar -->
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-circle" src="{{ asset('silicon-front/assets/images/avatar/05.jpg') }}"
                                                    alt="avatar">
                                            </div>
                                        </div>
                                        <!-- Divider -->
                            ...
                            <div class="pb-4">
                                <div class="card p-2 border">
                                    <div class="rounded-top overflow-hidden">
                                        <div class="card-overlay-hover">
                                            <img src="{{ asset('silicon-front/assets/images/courses/4by3/20.jpg') }}" class="card-img-top"
                                                alt="course image">
                                        </div>
                                        <!-- Hover element -->
                                        <div class="card-img-overlay">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            ...
                                            <!-- Avatar -->
                                            <div class="avatar avatar-sm">
                                                <img class="avatar-img rounded-circle" src="{{ asset('silicon-front/assets/images/avatar/02.jpg') }}"
                                                    alt="avatar">
                                            </div>
                                        </div>
                                        <!-- Divider -->
