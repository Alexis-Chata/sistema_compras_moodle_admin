<div class="align-items-center d-flex justify-content-between" style="gap: 10px;">
    <span class="h6 fw-light mb-0">
        <button type="button"
            class="course-card-btn small s-border-none background transparent-color s-cursor-pointer s-cross-center s-nowrap base m-0 btn btn-success"
            style="border: none;"  wire:click="addItem" wire:loading.attr="disabled">
            ...
            <span class="color s-font-semibold blue-500 s-whitespace-nowrap undefined">Comprar</span>
        </button>
    </span>
    @if ($encarrito)
        <span class="h6 fw-light mb-0">{{ Cart::instance('carrito')->get($rowId)->options->modalidad; }} <a href="{{ route('carrito') }}">En Carrito</a></span>
    @endif
</div>
