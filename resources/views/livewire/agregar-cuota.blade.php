<div class="align-items-center d-flex justify-content-between" style="gap: 10px;">
    <span class="h6 fw-light mb-0">
        <button type="button"
            ...
            style="border: none;"  wire:click="agregarCuota" wire:loading.attr="disabled">
            ...
            <span class="color s-font-semibold blue-500 s-whitespace-nowrap undefined">Agregar Cuota {{-- $this->cuota->id --}}</span>
        </button>
    </span>
    @if ($encarrito)
